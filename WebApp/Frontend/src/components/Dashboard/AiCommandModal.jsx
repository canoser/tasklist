...
// [MOBILE_PORT_TODO]: AiCommandModal native'de sheet (bottom sheet) veya full-screen modal olarak tasarlanmalı. 
// Web'deki dialog elementleri native'de safe-area-inset ile çakışabilir. Bileşene platform prop'u eklenebilir veya native karşılığı ayrıca yazılabilir.
        ...
        >
          ...
          <div className={styles.header}>
            <h2 className={styles.headerTitle}>
              ✨ {step === 1 ? 'Akıllı Komut' : 'Plan Onayı'}
            </h2>
              ...
              >
                <div className={styles.inputGroup}>
                  ...
                  <div className={styles.promptWrapper}>
                    ...
                    />
                    {/* [MOBILE_PORT_TODO]: Native uygulamada fotoğraf çekmek veya galeriden seçmek için @capacitor/camera ve @capacitor/filesystem eklentileri kullanılmalıdır. Dosya seçimi sonrası base64 formatına çevrilip Storage API'sine yüklenmelidir. */}
              ...
              >
                ...
                <div className={styles.toolCallsList}>
                  {aiResponse.toolCalls?.map((call, index) => {
                    // C# DTO PascalCase ama System.Text.Json camelCase yapabilir
