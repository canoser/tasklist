...
const FileUploadModal = ({ isOpen, onClose, workspaceId, taskId, tone, onSuccess }) => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className={styles.overlay} onClick={!uploading ? onClose : undefined}>
          <motion.div
          ...
          >
            <div className={styles.header}>
              <h3 className={styles.title}>{t('ws_modal_upload_title', { context: tone, defaultValue: 'Dosya Yükle' })}</h3>
              {!uploading && (
