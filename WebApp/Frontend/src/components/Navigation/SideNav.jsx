...
const SideNav = ({ activeTab = 'home', onTabChange = () => {}, tone, user, openAuth }) => {
  ...
  return (
    <>
      <div className={`${styles.sideNavContainer} no-select`}>
        <div className={styles.logoArea}>
          <span className={styles.logoBadge}>P</span>
          <span className={styles.logoText}>{t('app_name', { context: tone, defaultValue: 'TaskList' })}</span>
        </div>
        ...
        <div className={styles.navItems}>
          ...
          >
            <SearchIcon />
            <span>{t('nav_workspace', { context: tone, defaultValue: 'Alanlarım' })}</span>
          </button>
          ...
          {user && (
            ...
            >
              <CoachIcon />
              <span>{t('nav_coaching', { context: tone, defaultValue: 'Koçluk' })}</span>
            </button>
          )}
